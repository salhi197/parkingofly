                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control "  value="{{old('categorie')}}" name="categorie">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                ...
                                                                <select class="form-control" id="parametre" name="parametre">
                                                                    ...
                                                                    ?>
                                                                    <option value="{{$s->id}}">{{$s->determination}}</option>
                                                                    <?php
                                                                        }
                                                                    ?>
                                                                </select>
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <input type="text" class="form-control" name="nomre" id="nomre" placeholder="nomre" >
                                                            </div>
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <select class="form-control" id="reference" name="reference">
                                                                        <?php 
                                                                            $_references = json_decode($produit->_references);
                                                                            foreach($_references as $_reference){
                                                                                $u = json_decode(json_decode($_reference));
                                                                        ?>
                                                                        <option value="{{$u->id}}">{{$u->methode}}</option>
                                                                        <?php
                                                                            }
                                                                        ?>
                                                                </select>
